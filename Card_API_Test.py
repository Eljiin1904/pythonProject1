...
def new_deck():
    print("\n")
    print(
        "Test Scenario 1.1: Validate the API/URL response has a new unique ID for DECK_ID value. Also validate the REMAINING value is equal to 52\n")
...
print(
    "\nNote:For the remaining tests, the value of the new DECK_ID must be passeed to the URL in the source code line 168")
...
def draw_card():
    print(
        "\nTest Scenario 1.2: Validate the API/URL response draws five random cars. Also vaildate (take note) of the first delt card. The card id will be passed in the URL for test case 1.3. Line 232. Finally validate the card count is 48 \n")
...
drawcards = requests.get("http://deckofcardsapi.com/api/deck/jmxlx92lyc1s/draw/?count=5")
drawcards = requests.get("http://deckofcardsapi.com/api/deck/jmxlx92lyc1s/draw/?count=4")
drawcards = requests.get("http://deckofcardsapi.com/api/deck/jmxlx92lyc1s/draw/?count=3")
drawcards = requests.get("http://deckofcardsapi.com/api/deck/jmxlx92lyc1s/draw/?count=2")
drawcards = requests.get("http://deckofcardsapi.com/api/deck/jmxlx92lyc1s/draw/?count=1")
print("\nTest API response below:")
